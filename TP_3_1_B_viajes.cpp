...
int main() {
    ...
    clearConsole();
    cout << "\nBienvenido al sistema reserva de viajes.\n";

    do {
        cout << "1- Tomar Reserva\n";
        cout << "2- Mostrar Reserva\n";
        cout << "0- Salir\n";
        cin >> menu;
        cin.ignore();
        switch(menu) {
            case 1: TomarReserva(nombre, apellido,dni,claseVuelo,origen,destino); break;
            case 2: Mostrarreserva(claseVuelo, dni, nombre, apellido, origen, destino); break;
            case 0: cout << "Gracias por usar el sistema de reservas.\n"; break;
